...
void OnStartGL()
{
	glEnable( GL_TEXTURE_2D );  // habilita manipulaçao de mapas de textura 2D (imagens)
...
/**
   \fn main()
   \brief Funcao principal representando o ponto de inicio da execuçao do codigo fonte
...
int main( int argc, char ** argv )
{
	...
	// inicializaçao do ambiente da GLUT
	glutInit( &argc, argv );
