/**
   \file Character.h
   \brief Descricao da classe de gerenciamento de personagens articulados

   Um personagem articulado e definido a partes das seguintes partes: cabeca, torax, braco esquerdo, antebraco esquerdo, mao esquerda, braco direito, antebraco direito, mao direita,
   coxa esquerda, perna esquerda, pe esquerdo, coxa direita, perna direita, pe direito.<br>
