...
/**
  \brief Constroi a cena a ser renderizada e animada nesta aplicação
*/
void Application::CreateScene()
{
	...
	ptrCamera->setTranslate( Vector3( 0.0f, 2.0, 7.0f ) );
	...
	BRep * ptrTreeType1 = new BRep();
	ptrTreeType1->LoadfromFile( strPath + "obj/Tree-1.obj" );
	ptrTreeType1->setScale( Vector3( 0.2f, 0.2f, 0.2f ));
	ptrTreeType1->setTranslate( Vector3( 0.0f, 0.0f, 2.0f ));
	this->addEntity( ptrTreeType1 );
	this->uiPolyCount += ptrTreeType1->getPolyCount();

	BRep * ptrTreeType2 = new BRep();
	ptrTreeType2->LoadfromFile( strPath + "obj/Tree-2.obj" );
	ptrTreeType2->setScale( Vector3( 0.2f, 0.2f, 0.2f ));
	ptrTreeType2->setTranslate( Vector3( 1.0f, 0.0f, -0.5f ));
	this->addEntity( ptrTreeType2 );
	this->uiPolyCount += ptrTreeType2->getPolyCount();

	BRep * ptrTreeType3 = new BRep();
	ptrTreeType3->LoadfromFile( strPath + "obj/Tree-3.obj" );
	ptrTreeType3->setScale( Vector3( 0.2f, 0.2f, 0.2f ));
	ptrTreeType3->setTranslate( Vector3( -1.0f, 0.0f, 0.0f ));
	this->addEntity( ptrTreeType3 );
	this->uiPolyCount += ptrTreeType3->getPolyCount();
