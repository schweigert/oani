/**
   \file PoseAttribute.h
   \brief Classe template que define o tipo de pose a ser armazenado para animacao keyframing (Pose-to-Pose)
...
{
public:
	typedef enum PoseAttributeType 
	{ 
