/**
   \file TexturedEntity.cpp
   \brief Implementacao dos metodos da classe TexturedEntity
...
unsigned int TexturedEntity::LoadTexture( string strFileName )
{
	...
	if( strcmpi( strExtension.c_str(), "bmp" ) == 0 )
	{
	...
	else if( strcmpi( strExtension.c_str(), "tga" ) == 0 )
	{
