/**
   ...
   \brief Implementacao dos metodos da classe BoundingSphere
...
bool BoundingSphere::CheckCollisionAgainstSphere( BoundingSphere* ptrOtherVolume )
{
    ...
    printf("Sphere vs Sphere... %f %f %f %f <-> %f %f %f %f", A.x, A.y, A.z, rA, B.x, B.y, B.z, rB );
